...
async def fill_data():    
    ...
    user_access_token_1, user_id_1 = create_user_entity("Where2BeOrg", "where2beorg", school1_id, True, False)
    user_access_token_2, user_id_2 = create_user_entity("Test User 1", "testuser1", school1_id, False, False)
    user_access_token_3, user_id_3 = create_user_entity("Where2BeAdmin", "where2beadmin", school1_id, True, True)
